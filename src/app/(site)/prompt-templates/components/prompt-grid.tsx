...
export function PromptGrid({ templates, onSelectTemplate }: PromptGridProps) {
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
      {templates.map((template, index) => (
        <motion.div
          ...
          className="group relative flex flex-col rounded-xl border border-zinc-800 bg-gradient-to-b from-zinc-900/80 to-zinc-950/80 hover:border-cyan-500/40 transition-all duration-300 cursor-pointer overflow-hidden hover:shadow-[0_0_30px_-10px_rgba(6,182,212,0.3)] hover:-translate-y-0.5"
        >
          {/* 顶部渐变装饰条 */}
